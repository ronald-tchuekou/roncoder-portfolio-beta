      ...
      <DropdownMenu>
         <DropdownMenuTrigger asChild>
            <Button
               ...
               aria-label={curLocale === 'en' ? 'Change language' : 'Changer de langue'}
            >
               <svg
               ...
               <span className='absolute -bottom-1 -left-1 text-base' aria-hidden='true'>
                  {curLocale === 'en' ? '🇬🇧' : '🇫🇷'}
               </span>
            </Button>
         </DropdownMenuTrigger>
         <DropdownMenuContent className='w-56' align='end'>
            <DropdownMenuItem asChild>
               <Button size='sm' variant={'ghost'} onClick={() => changeLang('en')} className='w-full justify-start'>
                  <Check className={cn('mr-2 invisible', { visible: curLocale === 'en' })} />
                  🇬🇧 English
               </Button>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
               <Button size='sm' variant={'ghost'} onClick={() => changeLang('fr')} className='w-full justify-start'>
