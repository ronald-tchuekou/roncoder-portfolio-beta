     ...
     >
        ...
        <div className={cn('flex gap-3')}>
           ...
           <RevealFromBottom delay={0.4}>
              <Button asChild size={'icon'} className='border-primary rounded-full text-primary' variant={'outline'}>
                 <Link
                    href={'https://linkedin.com/in/ronald-tchuekou'}
                    target='_blank'
           ...
           <RevealFromBottom delay={0.5}>
              <Button asChild size={'icon'} className='border-primary rounded-full text-primary' variant={'outline'}>
                 <Link
                    href='https://github.com/ronald-tchuekou'
                    target='_blank'
                    rel='noopener noreferrer'
                    title='GitHub'
                    aria-label='GitHub'
                 >
                    <svg aria-hidden='true' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' className='size-5'>
                       <path
                          fill='currentColor'
                          stroke='none'
           ...
           <RevealFromBottom delay={0.6}>
              <Button asChild size={'icon'} className='border-primary rounded-full text-primary' variant={'outline'}>
                 <Link
                    href={'https://x.com/TchuekouRonald'}
                    target='_blank'
                    rel='noopener noreferrer'
                    title='X'
           ...
           <RevealFromBottom delay={0.7}>
              <Button asChild size={'icon'} className='border-primary rounded-full text-primary' variant={'outline'}>
                 <Link
                    href={'https://youtube.com/@ronaldtchuekou'}
                    target='_blank'
                    rel='noopener noreferrer'
                    title='YouTube'
                    aria-label='YouTube'
