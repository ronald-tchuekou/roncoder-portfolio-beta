...
export const InfoSection: FC = () => {
  return (
    ...
    >
      ...
      >
        Salut, Moi c&apos;est <br />{" "}
        <span className="text-primary">Ronald Tchuekou</span>
      </RevealFromBottom>
      <RevealFromBottom elt={"p"} delay={0.3}>
        <span className="block">
          J&apos;excelle dans la création de plateformes et applications mobile
          élégantes.
        </span>
        <span className="block">
          J&apos;ai des compétences dans plusieurs variétés de langages et
          technologies.
        </span>
      </RevealFromBottom>
      <div className={cn("flex gap-3")}>
        ...
        <RevealFromBottom delay={0.4}>
          <Link
            href={"https://linkedin.com/in/ronald-tchuekou-02129b191"}
            target="_blank"
          >
            <Button
              size={"icon"}
